...
export default function TodosPage() {
  ...
  const filteredTodos = todos
    .filter((todo) => {
      ...
      const matchesStarred = showStarredOnly ? todo.isStarred : true;
      return matchesSearch && matchesStarred;
    })
    .sort((a, b) => {
      const dateA = a.createdDate ? parseISO(a.createdDate) : new Date(0); // Fallback to epoch if undefined
      const dateB = b.createdDate ? parseISO(b.createdDate) : new Date(0); // Fallback to epoch if undefined
  ...
  const handleEdit = (todo) => {
    ...
    setEditIsStarred(todo.isStarred);
  };
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center">
          <div className="relative flex-1 w-full sm:w-auto">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-400 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-base"
            />
          </div>
          <div className="flex items-center">
            <input
              ...
              className="h-5 w-5 text-emerald-600 border-gray-200 rounded focus:ring-emerald-500"
            />
          ...
          <select
            ...
            className="p-2 border border-gray-200 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-base"
          >
                    ...
                    {editId === todo.id ? (
                      <div className="space-y-6">
                        ...
                        <div className="flex items-center">
                          ...
                          />
                          <label className="ml-2 text-sm font-medium text-gray-700">
                            {editIsStarred ? "Starred" : "Not Starred"}
                          </label>
                        </div>
                      </div>
                    ) : (
